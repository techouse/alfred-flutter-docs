...
const ATTRIBUTES_TO_RETRIEVE: &[&str] = &["name", "qualifiedName", "href", "type", "enclosedBy"];

/// Configuration required to query the Flutter Algolia index.
...
/// Synchronous client for the Flutter documentation Algolia index.
#[derive(Clone, Debug)]
...
impl AlgoliaSearch {
    ...
    /// Searches Flutter API documentation and returns ranked hits.
