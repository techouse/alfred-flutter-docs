...
use alfred_flutter_docs::app::{google_fallback_item, items_from_results, placeholder_item};
use alfred_flutter_docs::models::SearchResult;
use alfred_flutter_docs::services::AlgoliaSearch;
use alfred_workflow_rs::{Icon, Item, RenderOptions, Updater, UserConfiguration, Workflow};
use anyhow::Result;

use crate::cli::Cli;

const GITHUB_REPOSITORY_URL: &str = "https://github.com/techouse/alfred-flutter-docs";
...
fn file_cache_key(query: &str) -> String {
    query.to_owned()
}
